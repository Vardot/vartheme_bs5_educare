...
namespace Drupal\vartheme_bs5_educare;
...
/**
 * Vartheme BS5 Educare theme starter kit implementation.
 *
 * Handles theme generation from the Vartheme BS5 Educare starter kit, including
 * renaming files, replacing theme names, and updating configuration files.
 */
final class StarterKit implements StarterKitInterface {

  /**
   * List of classes defined in Vartheme BS5 Educare.
   *
  ...
  public static function postProcess(string $working_dir, string $machine_name, string $theme_name): void {
    ...
    // Replace "Vartheme BS5 Educare" in class names before doing bulk find/replace.
    $old_pattern = 'Vartheme BS5 Educare';
    ...
    self::findAndReplace($working_dir, 'vartheme_bs5_educare', $machine_name);
    self::findAndReplace($working_dir, 'Vartheme BS5 Educare Starter Kit', $theme_name);
    self::findAndReplace($working_dir, 'Vartheme BS5 Educare', $theme_name);
    self::findAndReplace($working_dir, 'starterkit.md', 'README.md', TRUE);

    self::findAndReplace($working_dir, 'vartheme_bs5_educare_path', $machine_name . '_path');
