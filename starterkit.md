# Vartheme BS5 Educare Starterkit Theme

## How to use the Vartheme BS5 Educare Starterkit

To generate a new theme from Vartheme BS5 Educare using the starterkit/theme-generation
script, run the following from Drupal's installation root:

```sh
php core/scripts/drupal generate-theme new_theme_name --starterkit vartheme_bs5_educare
```
...
This script will copy over all the files from the Vartheme BS5 Educare theme, and replace
instances of Vartheme BS5 Educare's machine name and label with the strings you provide.

## Customizing CSS

Your new theme should look and function identically to Vartheme BS5 Educare out of the box,
but you may wish to change the styles to suit your needs. Vartheme BS5 Educare's styles are
...
[create a new issue](https://www.drupal.org/node/add/project-issue/vartheme_bs5_educare)
