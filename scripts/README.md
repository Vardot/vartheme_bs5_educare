...
2. Change directory in the terminal to `docroot/themes/contrib/vartheme_bs5_educare/scripts` in the project.
3. Run the `bash ./install-needed-tools.sh`
4. Follow with the list of instructions.

```
cd PROJECT_DIR_NAME/docroot/themes/contrib/vartheme_bs5_educare/scripts
